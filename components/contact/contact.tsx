                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-8 text-lg">
                        ...
                        <div className="flex flex-col md:flex-row gap-6 w-full">
                            <div className="flex flex-col gap-3 md:w-1/2">
                                <label htmlFor="name" className="text-[#919799] text-sm md:text-base font-bold uppercase tracking-wider">
                                    Name*
                                </label>
                                <input
                                    type="text"
                                    ...
                                    style={{ backgroundColor: "var(--input-box-color)", color: "var(--color-text)" }}
                                    required
                                />
                            </div>
                            <div className="flex flex-col gap-3 md:w-1/2">
                                <label htmlFor="email" className="text-[#919799] text-sm md:text-base font-bold uppercase tracking-wider">
                                    Email*
                                </label>
                                <input
                                    type="email"
                        ...
                        <div className="flex flex-col gap-3">
                            <label htmlFor="comment" className="text-[#919799] text-sm md:text-base font-bold uppercase tracking-wider">
                                Comment*
                            </label>
                            <textarea
                                name="comment"
                        ...
                        <div className="pt-4">
                            <button
                                ...
                                className="w-3/5 md:w-auto px-12 py-4 transition-colors rounded-full text-sm md:text-base font-bold uppercase tracking-widest disabled:opacity-60"
