    ...
    if (!data) {
        return (
            <main className="min-h-screen flex items-center justify-center">
                <p className="text-2xl font-glorify text-[var(--color-text)]">Project not found.</p>
            </main>
        );
    }
                ...
                <section className="flex flex-col justify-center items-center gap-20">
                    ...
                    <section>
                        <div className="flex flex-col gap-3">
                            <div key={data.description[0].subtitle} className="flex flex-row gap-5 w-full align-center justify-center w-full p-5">
                    ...
                    <section className="flex flex-col justify-center items-center ">
                        <div className="flex flex-row gap-5">
                            <div>
                                <Image src={data.images[1].src} alt={data.images[1].alt} width={parseSize(data.images[1].width)} height={parseSize(data.images[1].height)} />
                            </div>
                            <div>
                                <Image src={data.images[2].src} alt={data.images[2].alt} width={parseSize(data.images[2].width)} height={parseSize(data.images[2].height)} />
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        <div className="flex flex-col gap-3">
                            <div key={data.description[1].subtitle} className="flex flex-row gap-5 w-full align-center justify-center w-full p-5">
                                <h2 className="w-1/2 text-[3.5rem] uppercase tracking-widest font-bold font-glorify text-[var(--color-text)]  pb-2">
                                ...
                                <div className="w-1/2 flex flex-col justify-center items-start  gap-2">
                                    ...
                                    <div className="flex flex-col gap-2 ps-5">
                                        <p className=" text-[20px] leading-relaxed text-[var(--color-text-muted)] flex flex-row items-center gap-2">
                                            <Image src="/images/icon/check-mark.png" alt="checkmark" width={20} height={20} />
                    ...
                    <section className="flex w-full flex-col justify-center items-center gap-5 px-10">
                        <div className="w-full ">
                            <Image src={data.images[3].src} alt={data.images[3].alt} width={parseSize(data.images[3].width)} height={parseSize(data.images[3].height)} />
                        </div>
                        <div className="flex flex-row gap-5">
                            <div>
                                <Image src={data.images[4].src} alt={data.images[4].alt} width={parseSize(data.images[4].width)} height={parseSize(data.images[4].height)} />
                            </div>
                            <div>
                                <Image src={data.images[5].src} alt={data.images[5].alt} width={parseSize(data.images[5].width)} height={parseSize(data.images[5].height)} />
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        <div className="flex flex-col gap-3">
                            <div key={data.description[2].subtitle} className="flex flex-row gap-5 w-full align-center justify-center w-full p-5">
                                <h2 className="w-1/2 text-[3.5rem] uppercase tracking-widest font-bold font-glorify text-[var(--color-text)]  pb-2">
